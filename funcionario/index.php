...
<table class="table table-hover">
    ...
    <?php if ($funcionarios) : ?>
        <?php foreach ($funcionarios as $funcionario) : ?>
            <tr>
                <td><?php echo $funcionario['cod_func']; ?></td>
                <td><?php echo $funcionario['nome']; ?></td>
                <td><?php echo $funcionario['sobrenome']; ?></td>
                <td><?php echo $funcionario['setor']; ?></td>
                <td><?php echo $funcionario['funcao']; ?></td>
                <td class="actions text-right">
                    <a href="edit.php?cod_func=<?php echo $funcionario['cod_func']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i> Editar</a>
                    <a href="#" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete-modal-func" data-funcionario="<?php echo $funcionario['cod_func']; ?>">
